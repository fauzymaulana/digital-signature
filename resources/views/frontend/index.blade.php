...
<head>
    ...
    <title>Universitas Al Washliyah Medan {{ $titlePage }}</title>
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-success navbar-dark">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link" href="{{ URL::to('login') }}" role="button">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="bg-success">
                <a href="{{ URL::to('/') }}" class="brand-link text-center">
                    <span class="brand-text fw-bolder">UNIVA MEDAN</span>
                </a>
            </div>
